...
def game_over():
    ...
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,
                       font=("montseratt", 50), text="GAME OVER", fill="red", tags="game_over")
...
def new_game():
    ...
    # Delete existing snake and food
    canvas.delete("snake")
    canvas.delete("food")
    ...
    # Remove the game over message if displayed
...
score = 0
direction = 'right'
label = Label(window, text="score:{}".format(score), font=("montseratt", 20))
label.pack()
